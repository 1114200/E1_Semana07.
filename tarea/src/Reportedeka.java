 ...
 * @author USP
 */
public class Reportedeka extends javax.swing.JFrame {

    /**
     * Creates new form Reportedeka
     */
    public Reportedeka() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Reporte de kardex de notas de un alumno.");

        jLabel7.setText("CICLO");

        jButton1.setText("REPORTE");
        jButton1.setActionCommand("REPORTE");
        ...
        jLabel7.getAccessibleContext().setAccessibleName("CICLO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reportedeka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reportedeka().setVisible(true);
            }
        });
    }
